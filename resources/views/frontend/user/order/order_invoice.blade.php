  ...
  <table width="100%">
    ...
    <tbody>
     ...
     @forelse($orderItems as $orderItem)
      <tr class="font">
        <td align="center">
            <img src="{{ public_path(@$orderItem->product->product_thambnail) }}" height="60px;" width="60px;" alt="">
        </td>
        <td align="center">{{ @$orderItem->product->product_name_en }}</td>
        <td align="center">
        ...
        <td align="center">${{ @$orderItem->price * @$orderItem->qty}}</td>
      </tr>
     @empty
     @endforelse 
