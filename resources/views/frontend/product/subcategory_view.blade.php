  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <li class='active'>{{ $breadSubCat->subcategory_name_en }}</li>
      </ul>
    </div>
    <!-- /.breadcrumb-inner --> 
  </div>
  ...
  <div class='container'>
    <div class='row'>
      ...
      <div class='col-md-9'> 
        ...
        <span class="badge badge-pill" style="background-color: #008000">{{ $breadSubCat->category->category_name_en }}</span>
        / 
        <span class="badge badge-pill" style="background-color: #FF0000">{{ $breadSubCat->subcategory_name_en }}</span>
