  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        <li><a href="#">Home</a></li>
        <li class='active'>{{ $breadSubSubCat->category->category_name_en }}</li>
        <li class='active'>{{ $breadSubSubCat->subcategory->subcategory_name_en }}</li>
        <li class='active'>{{ $breadSubSubCat->subsubcategory_name_en }}</li>
      </ul>
    </div>
    <!-- /.breadcrumb-inner --> 
  </div>
  ...
  <div class='container'>
    <div class='row'>
              ...
              <div class="sidebar-widget-body">
                ...
                @foreach($categories as $row)
                  <div class="accordion-group">
                    <div class="accordion-heading"> <a href="#collapse{{ $row->id }}" data-toggle="collapse" class="accordion-toggle collapsed"> @if(session()->get('language') == 'bangla') {{ @$row->category_name_bn }} @else {{ @$row->category_name_en }} @endif </a> </div>
                    <!-- /.accordion-heading -->
                      ...
                      <div class="accordion-inner">
                        <ul>
                          ...
                          @foreach($subcategories as $row)
                          	<li><a href="{{ route('subcategory.product', ['subcat_id'=>$row->id, 'slug'=>$row->subcategory_slug_en]) }}">@if(session()->get('language') == 'bangla') {{ @$row->subcategory_name_bn }} @else {{ @$row->subcategory_name_en }} @endif</a></li>
                          @endforeach
                          {{-- end Sub-Categories --}}
                        </ul>
                      </div>
      ...
      <div class='col-md-9'> 
        ...
        <span class="badge badge-pill" style="background-color: #008000">{{ $breadSubSubCat->category->category_name_en }}</span>
        / 
        <span class="badge badge-pill" style="background-color: #FF0000">{{ $breadSubSubCat->subcategory->subcategory_name_en }}</span>
        /
        <span class="badge badge-pill" style="background-color: #FFA500">{{ $breadSubSubCat->subsubcategory_name_en }}</span>
            ...
            <div class="tab-pane active " id="grid-container">
              <div class="category-product">
                ...
                @foreach($products as $row)	
                  ...
                  <!-- /.item -->
                @endforeach
                {{-- End Sub-Subcategory Wise Products --}}
                    ...
                    <div class="product-list product">
                      <div class="row product-list-row">
                        <div class="col col-sm-4 col-lg-4">
                          <div class="product-image">
                            <div class="image"> <img src="{{ asset(@$row->product_thambnail) }}" alt=""> </div>
                          </div>
                          <!-- /.product-image --> 
                        </div>
                        <!-- /.col -->
                        <div class="col col-sm-8 col-lg-8">
                          <div class="product-info">
                            ...
                            <div class="description m-t-10">
                            	@if(session()->get('language') == 'bangla') {{ @$row->short_descp_bn }} @else {{ @$row->short_descp_en }} @endif
                            </div>
                            <div class="cart clearfix animate-effect">
                              <div class="action">
                                <ul class="list-unstyled">
