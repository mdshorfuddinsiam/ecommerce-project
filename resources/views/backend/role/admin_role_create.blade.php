					...
					<form method="post" action="{{ route('store.admin.user') }}" enctype="multipart/form-data">
					  ...
					  <div class="row">
						<div class="col-12">
							...
							<div class="row">
								...
								<div class="col-6">
									<div class="form-group">
										...
										<div class="controls">
											<input type="email" name="email" class="form-control" value="" required=""> </div>
									</div>
								</div> {{-- end col-6 --}}
							</div> {{-- end row --}}
							...
							<div class="row">
								<div class="col-6">
									<div class="form-group">
										...
										<div class="controls">
											<input type="text" name="phone" class="form-control" value="" required=""> </div>
									</div>
								</div> {{-- end col-6 --}}
								<div class="col-6">
									<div class="form-group">
										...
										<div class="controls">
											<input type="password" name="password" class="form-control" value="" required=""> </div>
									</div>
								</div> {{-- end col-6 --}}
							</div> {{-- end row --}}
							...
							<div class="row">
								<div class="col-4">
									<div class="form-group">
										<div class="controls">
											<input type="checkbox" name="brand" id="brand" value="1">
								...
								<div class="col-4">
									<div class="form-group">
										<div class="controls">
											<input type="checkbox" name="shipping" id="shipping" value="1">
										...
										<div class="controls">
											<input type="checkbox" name="returnorder" id="returnorder" value="1">
								...
								<div class="col-4">
									<div class="form-group">
										...
										<div class="controls">
											<input type="checkbox" name="alluser" id="alluser" value="1">
											<label for="alluser">All Users</label>
										</div>	
										<div class="controls">
											<input type="checkbox" name="adminuserrole" id="adminuserrole" value="1">
						...
						<div class="text-xs-right">
							<input type="submit" class="btn btn-rounded btn-primary mb-5" value="Add New Admin">
						</div>
					</form>
