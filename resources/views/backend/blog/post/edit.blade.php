							...
							<div class="row">
								...
								<div class="col-6">
									<div class="form-group">
										...
										<div class="controls">
											<input type="text" name="post_title_bn" class="form-control" value="{{ @$blogPost->post_title_bn }}" required=""> </div>
									</div>
								</div> {{-- end col-6 --}}
							</div>	{{-- end row 1st --}}
										...
										<div class="controls">
											<select name="blogcategory_id" id="blogcategory_id" required="" class="form-control select2" style="width: 100%;">
												...
												@forelse($blogCategories as $row)
													<option value="{{ @$row->id }}" {{ @$blogPost->blogcategory_id == @$row->id ? 'selected' : '' }}>{{ @$row->blog_category_name_en }}</option>
												@empty
												@endforelse
											</select>
										</div>
								...
								<div class="col-6">
									<div class="form-group">
										...
										<div class="controls">
											...
											<img src="{{ asset(@$blogPost->post_image) }}" width="80" id="mainThmb">
										</div>
									</div>
								</div> {{-- end col-6 --}}
							</div>	{{-- end row 2nd --}}
							...
							<div class="row">
								<div class="col-6">
									<div class="form-group">
										...
										<div class="controls">
											<textarea name="post_details_en" id="post_details_en" class="form-control"  required="" rows="10" cols="80" >{{ @$blogPost->post_details_en }}</textarea>
										</div>
									</div>
								</div> {{-- end col-6 --}}
								...
								<div class="col-6">
									<div class="form-group">
										...
										<div class="controls">
											<textarea name="post_details_bn" id="post_details_bn" class="form-control" required="" rows="10" cols="80" >{{ @$blogPost->post_details_bn }}</textarea>
										</div>
									</div>
								</div> {{-- end col-6 --}}
							</div>	{{-- end row 3rd --}}	
							...
							<div class="row">
								<div class="col-6">
									<div class="form-group">
										<h5>Author </h5>
										<div class="controls">
											<input type="text" name="author" class="form-control" value="{{ @$blogPost->author }}"> 
										</div>
									</div>
								</div> {{-- end col-6 --}}
								<div class="col-6">
